...
public class MainActivityEventsExamen implements LoginFragmentsListener, RegisterFragmentsListener, FireBaseAdminListener {
    MainActivity mainActivity;

    public MainActivityEventsExamen(MainActivityExamen mainActivity) {
